...
void setup()
{
    ...
    pinMode(D6,OUTPUT);     // ctest indicator
}
...
void loop(void)
{
    if (digitalRead(D2))    // if the switch is open test and look for serial
    {
    ...
    else            // if switch is closed transfer serial telemetry
    {
